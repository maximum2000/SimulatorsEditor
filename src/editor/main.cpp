...
void CreateDemonstrationMenuMM() 
{
    ...
    io.Fonts->AddFontFromFileTTF("C:/Users/Ìèõàèë/Desktop/projects/SimulatorsEditor/src/editor/LiberationSans.ttf", 14.0f, NULL, io.Fonts->GetGlyphRangesCyrillic());
