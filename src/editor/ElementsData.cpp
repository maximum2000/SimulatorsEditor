...
namespace ScenariosEditorElementsData
{
	...
	static std::map <std::string, std::string> AttributesHints = {
		...
		{u8"Text", u8"Текст"},
		{u8"WithButtonOk", u8"1 - с клавишей ОК\n0 - Без неё"},
		...
		{u8"Detection", u8"1 - С учётом обнаружения\n0 - без"},
		{u8"Diagnostics", u8"1 - С учётом диагностики\n0 - без"},
		{u8"MakingDecisions", u8"1 - С учётом принятия решений\n0 - без"},
		{u8"ActionsPerformed", u8"1 - С учётом выполняемых действий\n0 - без"},
		...
		{u8"MyActionsButton", u8"1 - С кнопкой \"Мои действия\"\n0 - без"},
